...
echo '<form action="admin.php?page=settings_cb_p2&'.$this->internal['prefix'].'tab=languages" name="" method="post" class="'.$this->internal['prefix'].'inline_block_form">';
...
echo '<form action="admin.php?page=settings_cb_p2&'.$this->internal['prefix'].'tab=languages" name="" method="post">';
